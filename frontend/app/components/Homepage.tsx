...
export default function Homepage() {
    return (
        <section className="w-full h-full px-10 py-12 md:py-24 overflow-hidden text-white">
            ...
            <div className="flex flex-col h-full min-h-screen items-center text-center lg:space-y-6 px-4 relative sm:gap-4 lg:gap-4">
                <Badge className="px-3 py-1 border-purple-500 font-sans">AI-Powered Screenshot Management</Badge>
                <motion.div
