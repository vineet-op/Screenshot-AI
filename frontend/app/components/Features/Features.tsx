...
export default function Features() {
    return (
        <section id="features" className="mt-5 relative w-screen h-full">
            <div className="container px-6 md:px-8 relative z-10">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center space-y-4 mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent font-sans tracking-tight">
                            AI-Powered Screenshot Management
                        </h2>
                        <p className="text-xl text-gray-400 max-w-2xl mx-auto font-sans tracking-tight">
